...
1. as the economic growth, how is the environmental impact increase as more product are product, by assuming resource input and the production is proportional.
2. what are the relationship between environmental impacts and six defined resource inputs?
3. Is there any industry(s) has extraordinary environmental impact compared to other?


# Hightlight of result

* On average, as production increase by 1%, most environmental impacts increase by more than 1%, but toxic production increase by less than 1%.
* for dog and cat food Manufacturing, the greatest environmental impacts come from raw material production industries such as agricultural farming, and utility sector of Electric Power Generation, Transmission and Distribution
* the industries using biowaste as energy source have higher impact in toxic.
