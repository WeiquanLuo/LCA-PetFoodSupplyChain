...
# result
coef_signif_list$sum_elastic <- coef_list[,3:8] %>% rowSums(na.rm = TRUE)
coef_signif_list %>% arrange(desc(adj.r.squared)) %>% knitr::kable(format = "markdown") 
```

| target            | r.squared | adj.r.squared | p.value | (Intercept)    | BioWasteTJ    | CoalTJ        | NatGaseTJ     | NonFossElecTJ | PetrolTJ      | WaterWithdrawalsKgal | sum\_elastic |
| :---------------- | --------: | ------------: | ------: | :------------- | :------------ | :------------ | :------------ | :------------ | :------------ | :------------------- | -----------: |
| CO2.Fossil.t.CO2e | 0.9910351 |     0.9908457 |       0 | \-2.48(\*\*\*) | 0.262(\*\*\*) | 0.237(\*\*\*) | 0.658(\*\*\*) | \-0.252(\*)   |               |                      |    0.9062298 |
| Total.t.CO2e      | 0.9828135 |     0.9823259 |       0 | \-1.6(\*\*\*)  | 0.244(\*\*\*) | 0.334(\*\*\*) | 0.573(\*\*\*) | \-0.229(\*)   |               |                      |    0.9228727 |
| SO2.t             | 0.9283235 |     0.9267985 |       0 | \-0.76(\*\*)   | 0.18(\*\*\*)  | 0.172(\*\*)   | 0.636(\*\*\*) |               |               |                      |    0.9875906 |
| NOx.t             | 0.9117863 |     0.9099226 |       0 | 3.39(\*\*\*)   |               |               |               | 1.1(\*\*\*)   |               |                      |    1.0963829 |
| PM10.t            | 0.8891458 |     0.8860010 |       0 | 0.842          |               | 0.847(\*\*\*) |               |               |               |                      |    0.8469015 |
| PM2.5.t           | 0.8781678 |     0.8745845 |       0 | \-4.38(\*\*\*) | 0.237(\*\*)   |               | 0.725(\*\*\*) |               |               |                      |    0.9623659 |
| NH3.t             | 0.7683303 |     0.7642299 |       0 | 5.29(\*\*\*)   |               | 0.141(\*\*\*) | 0.68(\*\*\*)  |               | 0.195(\*\*\*) |                      |    1.0162963 |
| CO.t              | 0.7511409 |     0.7476604 |       0 | \-0.948(\*)    | 0.275(\*\*\*) |               | 0.676(\*\*\*) |               |               |                      |    0.9506601 |
| VOC.t             | 0.6905785 |     0.6862205 |       0 | 2.74(\*\*\*)   |               |               |               | 1.07(\*\*\*)  |               |                      |    1.0727087 |
| Total.Air.kg      | 0.6697148 |     0.6649625 |       0 | 5.2(\*\*\*)    |               |               |               | 1.23(\*\*\*)  |               |                      |    1.2283948 |
| Fugitive.kg       | 0.6404521 |     0.6378467 |       0 | \-2.31(\*\*)   |               |               |               | 0.89(\*\*\*)  |               |                      |    0.8896791 |
| Surface.water.kg  | 0.6229475 |     0.6194563 |       0 | 2.97(\*\*\*)   |               |               | 1.5(\*\*\*)   |               |               |                      |    1.5031590 |
| Stack.kg          | 0.5949768 |     0.5920418 |       0 | 0.945(\*\*\*)  |               | 0.533(\*\*\*) | 0.166(\*)     |               | 0.35(\*\*\*)  |                      |    1.0491144 |
| POTW.Metal.kg     | 0.4867847 |     0.4817033 |       0 | \-1.03(\*)     | 0.215(\*\*)   |               |               | 0.755(\*\*\*) |               |                      |    0.9694040 |
| Offiste.kg        | 0.4845963 |     0.4806316 |       0 | 5.8(\*\*\*)    |               | 0.165(\*\*\*) | 0.707(\*\*\*) |               | 0.204(\*\*\*) | \-0.0377(\*)         |    1.0391455 |
| Land.kg           | 0.4658109 |     0.4611250 |       0 | 5.65(\*\*\*)   |               |               |               | 0.9(\*\*\*)   | 0.249(\*\*)   |                      |    1.1491955 |
